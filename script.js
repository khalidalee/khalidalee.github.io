...
function initPdfEngine() {
    ...
    downloadBtn.addEventListener('click', () => {
        ...
        if (!pdfTemplate) {
            // Fallback to static download if template is missing
            const downloadAnchor = document.createElement('a');
            downloadAnchor.href = 'KhalidAli.pdf';
            downloadAnchor.download = 'Khalid_Ali_Executive_CV.pdf';
